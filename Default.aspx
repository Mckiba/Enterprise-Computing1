...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
          ...
          <div class="row">
        <div class="col-md-4">
                          <asp:Image ID="ftProduct1"   Width="250px" Height="350px" runat="server" />
        ...
        <div class="col-md-4">
                          <asp:Image ID="ftProduct2"   Width="250px" Height="350px" runat="server"  />
        ...
        <div class="col-md-4">
                           <asp:Image ID="ftProduct3"   Width="250px" Height="350px" runat="server" />
